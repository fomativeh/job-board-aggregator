...
def test_validate_listing_rejects_weworkremotely_source_removed() -> None:
    removed = _make_listing("https://ex.com/1")
    removed["source"] = "weworkremotely"
    with pytest.raises(ValidationError):
...
def test_build_headers_rotates_user_agent() -> None:
    ...
    for _ in range(200):
        h = build_headers("https://boards.greenhouse.io/stripe/jobs/1234?gh_jid=1234", referer="https://boards.greenhouse.io/")
...
def test_build_headers_contextualizes_sec_fetch_and_referer() -> None:
    same = build_headers(
        "https://boards.greenhouse.io/stripe/jobs/1234?gh_jid=1234",
    ...
    assert same["Referer"] == "https://boards.greenhouse.io/"
